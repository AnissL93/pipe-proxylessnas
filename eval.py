...
from search.utils.pipeline_config import *
from search.utils.latency_estimator import *
...
config.add_stage_mapping((0, 15), "big")
config.add_stage_mapping((15, 25), "small")

net.net_latency(config=config, device="soc", latency_estimator=HeteroLatencyEstimator("./search/data/latency.yaml"))
